...
namespace MiCodeFirst_DataAnnotations.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AluID,Apellidos,Nombre,FechaMatricula")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AluID,Apellidos,Nombre,FechaMatricula")] Alumno alumno)
        {
            if (ModelState.IsValid)
            {
